...
// 따라서, 데이터베이스 통신을 위한 설정 값을 application.properties에 저장을 하고
...
public class MyBatisConfig {
    ...
    // 객체들 중 특수한 성격을 띠늰 친구들은 우리가 직접 @Controller, @Service
    // 같은 어노이테이션을 붙여주지만, 만약 스프링 프레임워크가 직접 관리해야할 객체들 중
    // 특수한 성격을 띄지 않거나 별개의 라이브러리 객체일 경우에는 우리가
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        //sqlSessionFactoryBean.setMapperLocations(new ClassPathResource("mybatis/mappers/*.xml"));
